...
plt.ylabel('RMSE')
plt.title('Augmentation Sensitivity: Air Quality Index Imputation with 10% Missing Data')
plt.tight_layout()
...
plt.title('Augmented Size vs Stride: Air Quality Index Imputation with 10% Missing Data')
plt.tight_layout()
