...
from AGG.experiments import AGGExperiment_Activity
from AGG.extended_typing import collate_graph_samples
from Datasets.Localisation.datareader import ActivityData
...
def main():
    ...
    version_path = (
        f"AGG-activity_{int(config['data_params']['sparsity'] * 100)}%_"
